...
const ConstructorStandingsPage = () => {
    ...
    return (
        <main className="ml-64 px-12 py-8 w-full">
            ...
            <div className="grid grid-cols-10 font-semibold border-b-2 pb-2 mb-4 border-red-600">
            ...
            <div className="flex flex-col space-y-4">
                {constructorStandings.map(team => (
                    <div key={team.Constructor.constructorId}
                        className="grid grid-cols-10 items-center bg-white rounded-lg shadow-sm py-4">
